...
**输出格式**：使用标准的 spec-kit spec 文档格式，包含所有必要的章节和标记。"""
    
    @staticmethod
    def generate_spec_system_prompt() -> str:
        """生成 spec 文档的系统 prompt"""
        return '你是一个 spec-kit 专家，擅长创建用于指导 C 到 Rust 项目转换的功能规格文档。'
...
**输出格式**：使用 spec-kit 的 plan-template.md 格式。"""
    
    @staticmethod
    def generate_plan_system_prompt() -> str:
        """生成 plan 文档的系统 prompt"""
        return '你是一个 Rust 架构师，擅长制定从 C 到 Rust 的详细实现计划。'
...
**输出格式**：使用 spec-kit 的 tasks-template.md 格式。"""
    
    @staticmethod
    def generate_tasks_system_prompt() -> str:
        """生成 tasks 文档的系统 prompt"""
        return '你是一个 Rust 开发专家，擅长创建详细的 C 到 Rust 转换任务列表。'
...
**输出格式**：使用标准的 spec-kit spec 文档格式。"""
    
    @staticmethod
    def generate_module_spec_system_prompt() -> str:
        """生成模块 spec 文档的系统 prompt"""
        return '你是一个 spec-kit 专家，擅长为单个 C 模块创建功能规格文档。'
...
**输出格式**：使用 spec-kit 的 plan-template.md 格式。"""
    ...
    def generate_module_plan_system_prompt() -> str:
        """生成模块 plan 文档的系统 prompt"""
        return '你是一个 Rust 架构师，擅长为单个 C 模块制定 Rust 实现计划。'
...
**输出格式**：使用 spec-kit 的 tasks-template.md 格式。"""
    ...
    def generate_module_tasks_system_prompt() -> str:
        """生成模块 tasks 文档的系统 prompt"""
        return '你是一个 Rust 开发专家，擅长为单个 C 模块创建详细任务列表。'
