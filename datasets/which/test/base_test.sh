...
run_test() {
    ...
    echo "Test Case #$current_test: Started" >> /home/unix/logs/out_flow_c.log
    echo "Test Case #$current_test: Started" >> /home/unix/logs/out_flow_rust.log
...
if [ $pass_rate -eq 100 ]; then
    ...
    for ((i=1; i<=total_tests; i++)); do
        if ! grep -q "Test Case #$i: Started" /home/unix/logs/out_flow_c.log; then
